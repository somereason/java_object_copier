package com.github.somereason.object_copier_example;


import com.github.somereason.object_copier.ClassMapper;
import com.github.somereason.object_copier.MappingManager;
import com.github.somereason.object_copier_example.entity.ListMapNestDto;
import com.github.somereason.object_copier_example.entity.ListMapNestModel;
import com.github.somereason.object_copier_example.entity.SimpleDto;
import com.github.somereason.object_copier_example.entity.SimpleModel;
...
//        startTick1 = System.currentTimeMillis();
//        for (int i = 0; i < 500; i++) {
//            List<ListMapNestModel> modelAuto = mapper.map(dtos);
//        }
//        endTick1 = System.currentTimeMillis();
